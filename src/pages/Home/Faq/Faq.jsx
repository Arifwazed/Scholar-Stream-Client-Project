    ...
    return (
        <div className="max-w-full mx-auto px-4 md:px-40 py-12 ">
            <div className='text-center mb-8'>
                <h2 className="text-primary text-4xl md:text-5xl font-semibold"><span className="bg-linear-to-r from-pink-500 to-blue-600 bg-clip-text text-transparent">Frequently Asked Questions</span></h2>
                <p className='my-3 text-lg md:text-xl text-base-100'>Got questions about scholarships or using ScholarStream? Explore our FAQs to find clear answers and make your scholarship journey easier</p>
            </div>
