...
const AllReviews = () => {
    ...
    return (
        <div className="p-4 space-y-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-center "><span className="bg-linear-to-r from-pink-500 to-blue-600 bg-clip-text text-transparent">All Reviews: {allReviews.length}</span></h1>
